...
/* Subroutine */int MCSRCH(size_t *n, double *x, double *f, double *g,
		double *s, double *stp, double *ftol, double *gtol, double *xtol,
		double *stpmin, double * stpmax, size_t *maxfev, ptrdiff_t *info,
		size_t *nfev, double *wa, size_t *keep, double *rkeep,
		double *cg_dginit, bool weak_wolf)
{
	/* Local variables */
	static double dg, fm, fx, fy, dgm, dgx, dgy, fxm, fym, stx, sty;
	static double dgxm, dgym;

	static ptrdiff_t infoc;
	static double finit;
	static double width;
